...
// src/search-sends.tsx
var search_sends_exports = {};
__export(search_sends_exports, {
  default: () => search_sends_default
});
module.exports = __toCommonJS(search_sends_exports);
...
var UnlockForm = ({ pendingAction = Promise.resolve() }) => {
  ...
  async function onSubmit() {
    ...
    try {
      ...
      await pendingAction;
      const toast = await (0, import_api15.showToast)({ title: "Validating...", message: "Please wait", style: import_api15.Toast.Style.Animated });
      ...
      toast.style = import_api15.Toast.Style.Success;
  ...
  async function handleUnlockError(error, toastOptions) {
    ...
    await (0, import_api15.showToast)({
      title,
      message: displayableError,
      style: import_api15.Toast.Style.Failure,
    ...
    import_api15.Form,
    {
      actions: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_api15.ActionPanel, { children: [
        !isLoading && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_api15.Action.SubmitForm, { icon: import_api15.Icon.LockUnlocked, title: "Submit", onSubmit }),
...
// src/components/ListLoadingView.tsx
var import_api28 = require("@raycast/api");
var import_react13 = require("react");
var import_jsx_runtime18 = require("react/jsx-runtime");
var ProgressIcons = [import_api28.Icon.CircleProgress25, import_api28.Icon.CircleProgress50, import_api28.Icon.CircleProgress75, import_api28.Icon.CircleProgress100];
var ListLoadingView = (props) => {
  const [progressIconIndex, setProgressIconIndex] = (0, import_react13.useState)(0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_api28.List.EmptyView, { icon: ProgressIcons[progressIconIndex], ...props });
};
...
var RootErrorBoundary = class extends import_react14.Component {
  constructor(props) {
    super(props);
  ...
  async componentDidCatch(error, errorInfo) {
    if (error instanceof ManuallyThrownError) {
      ...
      await (0, import_api29.showToast)(import_api29.Toast.Style.Failure, error.message);
    } else {
      if (import_api29.environment.isDevelopment) {
        this.setState((state) => ({ ...state, hasError: true, error: error.message }));
      }
...
var CreateEditSendForm = ({
  ...
  async function onSubmit(values) {
    const toast = await (0, import_api30.showToast)({
      title: mode === "edit" ? "Updating Send..." : "Creating Send...",
      style: import_api30.Toast.Style.Animated
    });
    try {
      const result = await onSave(type, values);
      if (shouldCopyOnSave) {
        await import_api30.Clipboard.copy(result.accessUrl);
      ...
      toast.style = import_api30.Toast.Style.Success;
      ...
      toast.style = import_api30.Toast.Style.Failure;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
    import_api30.Form,
    {
      actions: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_api30.ActionPanel, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          import_api30.Action.SubmitForm,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(DebuggingBugReportingActionSection, {})
      ] }),
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          import_api30.Form.TextField,
          {
            ...itemProps.name,
            title: "Name",
        ...
        mode === "create" && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Dropdown, { id: "type", value: String(type), onChange: onTypeChange, title: "What type of Send is this?", children: Object.entries(SendTypeOptions).map(([value, title]) => /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Dropdown.Item, { value, title }, value)) }),
        type === 0 /* Text */ && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
            import_api30.Form.TextArea,
            {
              ...itemProps.text,
              title: "Text",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Checkbox, { ...itemProps.hidden, label: "Hide this Send's text by default" })
        ] }),
        type === 1 /* File */ && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_jsx_runtime20.Fragment, { children: mode === "create" ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          import_api30.Form.FilePicker,
          {
            ...itemProps.file,
            title: "File",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Description, { text: itemProps.file.value?.[0] ?? "No file found.", title: "File" }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Description, { text: "" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          import_api30.Form.Checkbox,
          {
            title: "Share",
            id: "copySendOnSave",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Description, { text: "" }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Separator, {}),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Description, { text: "Options" }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          import_api30.Form.Dropdown,
          {
            ...itemProps.deletionDate,
            title: "Deletion date",
            info: "The Send will be permanently deleted on the specified date and time.",
            children: Object.values(SendDateOption).map((value) => /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Dropdown.Item, { value, title: value }, value))
          }
        ),
        itemProps.deletionDate.value === "Custom" /* Custom */ && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.DatePicker, { ...itemProps.customDeletionDate, title: "Custom deletion date" }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
          import_api30.Form.Dropdown,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Dropdown.Item, { value: "", title: "Never" }),
              Object.values(SendDateOption).map((value) => /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Dropdown.Item, { value, title: value }, value))
            ]
          }
        ),
        itemProps.expirationDate.value === "Custom" /* Custom */ && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.DatePicker, { ...itemProps.customExpirationDate, title: "Custom expiration date" }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          import_api30.Form.TextField,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          import_api30.Form.PasswordField,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Checkbox, { ...itemProps.hideEmail, label: "Hide my email address from recipients" }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_api30.Form.Checkbox, { ...itemProps.disabled, label: "Deactivate this Send so no one can access it" })
      ]
    }
  );
};
...
var LoadingFallback2 = () => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_api31.Form, { isLoading: true });
var CreateSendCommand = (props) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(RootErrorBoundary, { children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(BitwardenProvider, { loadingFallback: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(LoadingFallback2, {}), children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(SessionProvider, { loadingFallback: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(LoadingFallback2, {}), unlock: true, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(CreateSendCommandContent, { ...props }) }) }) });
...
function CreateSendCommandContent({ send, onSuccess: onParentSuccess }) {
  ...
  const onSuccess = async (send2, wasUrlCopiedToClipboard) => {
    if (onParentSuccess) {
      ...
      await (0, import_api31.showHUD)("Send URL copied to clipboard", { popToRootType: import_api31.PopToRootType.Immediate });
    } else {
      await (0, import_api31.launchCommand)({ type: import_api31.LaunchType.UserInitiated, name: "search-sends" });
    }
  };
...
// src/utils/dates.ts
var getFormattedDate = (date, options) => {
  ...
  return date.toLocaleString("en-GB", {
    ...
    hour: "numeric",
    minute: "numeric",
    year: abbreviate && date.getFullYear() === (/* @__PURE__ */ new Date()).getFullYear() ? void 0 : "numeric",
    second: abbreviate && date.getSeconds() === 0 ? void 0 : "numeric",
    ...dateOptions
  });
};
...
var useInterval = (task, options) => {
  const { interval = 60 * 1e3, skip = false } = options ?? {};
...
var searchBarPlaceholder = "Search sends";
var LoadingFallback3 = () => /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_api33.List, { searchBarPlaceholder, isLoading: true });
var { syncOnLaunch: syncOnLaunch2 } = (0, import_api33.getPreferenceValues)();
var SearchSendsCommand = () => /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(RootErrorBoundary, { children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(BitwardenProvider, { loadingFallback: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(LoadingFallback3, {}), children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(SessionProvider, { loadingFallback: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(LoadingFallback3, {}), unlock: true, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(SearchSendsCommandContent, {}) }) }) });
var getItemIcon = (send) => {
  if (send.type === 1 /* File */) return { source: import_api33.Icon.Document, tintColor: import_api33.Color.Blue };
  return { source: import_api33.Icon.Text, tintColor: import_api33.Color.SecondaryText };
};
var getDateAccessoryDetails = (dateString) => {
  const date = new Date(dateString);
  const isPastDate = date < /* @__PURE__ */ new Date();
  return {
    date,
    isPastDate,
    color: isPastDate ? import_api33.Color.Red : void 0,
    textDate: getFormattedDate(date, { abbreviate: true, second: void 0 }),
    tooltipDate: getFormattedDate(date)
  };
};
var getItemAccessories = (send) => {
  const accessories = [];
  if (send.passwordSet) {
    accessories.push({ icon: import_api33.Icon.Key, tooltip: "Password protected" });
  }
  if (send.disabled) {
    accessories.push({ icon: { source: import_api33.Icon.Warning, tintColor: import_api33.Color.Orange }, tooltip: "Disabled" });
  }
  ...
  if (accessCount > 0 || maxAccessCount) {
    ...
    accessories.push({
      tag: { value: `${accessCount}`, color: wasMaxAccessReached ? import_api33.Color.Red : void 0 },
      icon: { source: import_api33.Icon.Person, tintColor: wasMaxAccessReached ? import_api33.Color.Red : void 0 },
      tooltip: maxAccessCount ? `Max access count reached: ${accessCount}/${maxAccessCount}` : `Access Count: ${accessCount}`
    });
  }
  if (send.expirationDate) {
    ...
    accessories.push({
      ...
      icon: { source: import_api33.Icon.Clock, tintColor: color },
      tooltip: isPastDate ? `Expired on ${tooltipDate}` : `Will expire on ${tooltipDate}`
    });
  }
  if (send.deletionDate) {
    const { color, textDate, tooltipDate, isPastDate } = getDateAccessoryDetails(send.deletionDate);
    accessories.push({
      text: { value: textDate, color },
      icon: { source: import_api33.Icon.Trash, tintColor: color },
      tooltip: isPastDate ? `Deleted on ${tooltipDate}` : `Will be deleted on ${tooltipDate}`
    });
  }
  return accessories;
};
var usePasteActionTitle = () => {
...
var useOperationQueue = () => {
  const operationQueueRef = (0, import_react17.useRef)([]);
  const currentOperationTimeoutRef = (0, import_react17.useRef)(void 0);
  const processOperations = () => {
    ...
    currentOperationTimeoutRef.current = setTimeout(async () => {
      try {
        ...
        currentOperationTimeoutRef.current = void 0;
  ...
  const queueOperation = (id, execute) => {
...
var sortSendsByName = (sendA, sendB) => sendA.name.localeCompare(sendB.name);
var useListSends = (bitwarden) => {
  const isFirstLoadRef = (0, import_react17.useRef)(true);
  const [type, setType] = $c40d7eded38ca69c$export$14afb9e4c16377d3(CACHE_KEYS.SEND_TYPE_FILTER);
  const listSends = async () => {
    const toast = isFirstLoadRef.current ? await (0, import_api33.showToast)({ title: "Loading Sends...", style: import_api33.Toast.Style.Animated }) : void 0;
    try {
      const listSends2 = await bitwarden.listSends();
      if (listSends2.result) listSends2.result.sort(sortSendsByName);
      return listSends2;
    } finally {
  ...
  const { data, isLoading, revalidate, mutate, error } = $cefc05764ce5eacd$export$dd6b79aaabe7bc37(listSends);
...
var syncAction = {
  title: "Sync Vault",
  shortcut: platform === "windows" ? { key: "r", modifiers: ["alt"] } : { key: "r", modifiers: ["opt"] },
  shortcutLabel: platform === "windows" ? "Alt+R" : "\u2325+R"
};
function SearchSendsCommandContent() {
  const { pop } = (0, import_api33.useNavigation)();
  const bitwarden = useBitwarden();
  ...
  const selectedItemIdRef = (0, import_react17.useRef)(void 0);
  useInterval(() => onSync(true), { skip: !called || !syncOnLaunch2 });
  function onSync(isPeriodic) {
    return queueOperation("sync", async () => {
      const toast = await (0, import_api33.showToast)({
        title: "Syncing vault...",
        message: isPeriodic ? "Background task" : void 0,
        style: import_api33.Toast.Style.Animated
      });
      try {
        ...
        if (isPeriodic) {
          ...
          toast.style = import_api33.Toast.Style.Success;
          toast.title = "Vault synced";
        }
      } catch (error) {
        toast.style = import_api33.Toast.Style.Failure;
  ...
  const onDelete = (id) => {
    return queueOperation(id, async () => {
      const toast = await (0, import_api33.showToast)({ title: "Deleting Send...", style: import_api33.Toast.Style.Animated });
      try {
  ...
  const onRemovePassword = (id) => {
    return queueOperation(id, async () => {
      const toast = await (0, import_api33.showToast)({ title: "Removing Send password...", style: import_api33.Toast.Style.Animated });
      try {
      ...
      try {
        await refreshSends({
          optimisticUpdate: (currentData) => {
            ...
            setTimeout(() => selectedItemIdRef.current = void 0, 1);
            return { result };
          },
        ...
        await (0, import_api33.showToast)({ title: "Failed to refresh Sends", style: import_api33.Toast.Style.Failure });
        captureException("Failed to refresh Sends", error);
      }
    });
  };
  const onEditSuccess = (updatedSend) => {
    pop();
    return queueOperation(updatedSend.id, async () => {
      try {
        ...
        await (0, import_api33.showToast)({ title: "Failed to sync Sends", style: import_api33.Toast.Style.Failure });
        captureException("Failed to sync Sends", error);
      }
    });
  };
  const onSendTypeChange = (value) => filterByType(value !== "" ? parseInt(value) : void 0);
  const searchBarAccessory = /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(import_api33.List.Dropdown, { tooltip: "Filter by Send type", onChange: onSendTypeChange, children: [
    /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_api33.List.Dropdown.Item, { title: "All", value: "" }),
    Object.entries(SendTypeOptions).map(([value, title]) => /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_api33.List.Dropdown.Item, { value, title }, value))
  ] });
  if (isFirstLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_api33.List, { searchBarPlaceholder, searchBarAccessory, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(ListLoadingView, { title: "Loading Sends...", description: "Please wait." }) });
  }
  const sendManagementActionSection = /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(import_api33.ActionPanel.Section, { title: "Send Management", children: [
    /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
      import_api33.Action.Push,
      {
        title: "Create New Send",
        target: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(create_send_default, { onSuccess: onCreateSuccess }),
        icon: import_api33.Icon.NewDocument,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
      import_api33.Action,
      {
        ...
        icon: import_api33.Icon.ArrowClockwise,
        shortcut: syncAction.shortcut
      }
    )
  ] });
  if (sends.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_api33.List, { searchBarPlaceholder, searchBarAccessory, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
      import_api33.List.EmptyView,
      {
        title: "There are no items to list.",
        icon: "sends-empty-list.svg",
        actions: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(import_api33.ActionPanel, { children: [
          sendManagementActionSection,
          /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(DebuggingBugReportingActionSection, {})
        ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
    import_api33.List,
    {
      ...
      searchBarAccessory,
      children: sends.map((send) => /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
        import_api33.List.Item,
        {
          id: send.id,
          title: send.name,
          ...
          actions: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(import_api33.ActionPanel, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_api33.Action.CopyToClipboard, { title: "Copy URL", content: send.accessUrl }),
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_api33.Action.Paste, { title: pasteActionTitle, content: send.accessUrl }),
            send.passwordSet && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
              import_api33.Action,
              {
                title: "Remove Password",
                onAction: () => onRemovePassword(send.id),
                icon: import_api33.Icon.LockUnlocked,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
              ...
              {
                title: "Edit Send",
                target: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(create_send_default, { send, onSuccess: onEditSuccess }),
                icon: import_api33.Icon.Pencil,
                shortcut: { macOS: { key: "e", modifiers: ["opt"] }, Windows: { key: "e", modifiers: ["alt"] } }
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
              ...
              {
                title: "Delete Send",
                style: import_api33.Action.Style.Destructive,
                onAction: () => onDelete(send.id),
                icon: import_api33.Icon.Trash,
...
var search_sends_default = SearchSendsCommand;
