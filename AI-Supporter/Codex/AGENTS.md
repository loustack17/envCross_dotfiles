...
- Never include assistant identity text such as `Co-Authored-By: Claude ...`, `Co-Authored-By: Codex ...`, `Generated by ...`, or similar AI disclosure text in Git history or GitHub records unless the user explicitly asks for it.
